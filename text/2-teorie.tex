...
% ML: Studenti jsou kratce ... (vynechal bych presto)
...
%% ML: mezi fyzicky a virtualnim dektop klientem moc rozdil neni,
%% maximalne, ze virtualni klient bezi nad Virtualboxem a muze k nemu
%% pripojit slozky z hostitelskeho OS (shared folders)
...
%% ML: NFS jiz pouziva dektopovy klient pro pripojeni domovsheho
%% adresare a dalsich (barrel, repository) z unitu (serveru). takze
%% jde pouze o to dovolit pripojeni disku u mimo desktop klienta
